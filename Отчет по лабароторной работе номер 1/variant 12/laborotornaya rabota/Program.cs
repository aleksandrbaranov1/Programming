...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.ReadKey(true);
        Console.WriteLine("-------------------------------------------------------------------------------------------------");
        Console.WriteLine("косинус:" + " " + Math.Cos((a * Math.PI) / 180));
        Console.WriteLine("синус:" + " " + Math.Sin((a * Math.PI) / 180));
        Console.WriteLine("тангенс" + " " + Math.Tan((a * Math.PI) / 180));
        ...
        Console.ReadKey(true);
        Console.WriteLine("-------------------------------------------------------------------------------------------------");
        Console.WriteLine("гиперболический косинус:" + " " + Math.Cosh((a * Math.PI) / 180));
        Console.WriteLine("гиперболический синус:" + " " + Math.Sinh((a * Math.PI) / 180));
        Console.WriteLine("гиперболический тангенс:" + " " + Math.Tanh((a * Math.PI) / 180));
